package com.example.flashlight_codsoft
...
import com.example.flashlight_codsoft.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Dexter.withContext(this).withPermission(android.Manifest.permission.CAMERA).withListener(object : PermissionListener{
            ...
            override fun onPermissionDenied(p0: PermissionDeniedResponse?) {
                Toast.makeText(this@MainActivity, "Please grant permission",Toast.LENGTH_LONG).show()
            }
